...
metadata:
  canonical: https://ecosoft.co.th/financial-statement-mis-tools
---
...
1. กดปุ่ม Create เพื่อเรียกรายงานตามรูปแบบที่สร้างไว้
2. กรอกข้อมูลเพิ่มเติมส่วนดังนี้
  * Name: ชื่อของรายงาน
  * Template: รูปแบบของรายงาน
  * Comparison Mode: ดูรายงานแบบเปรียบเทียบ
  * Columns: คลิก add line เพื่อเลือกช่วงวันที่ของรายงาน
